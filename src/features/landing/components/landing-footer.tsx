    ...
    <footer className="w-full border-t bg-muted/30">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="flex h-8 w-8 items-center justify-center rounded-md bg-muted hover:bg-muted/80 transition-colors"
                aria-label="Twitter"
              >
                <svg
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} UI SyncUp. All rights reserved.</p>
          <p>
            Built with{" "}
