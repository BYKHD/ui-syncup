...
interface ActivityItem {
  id: string;
  type: 'member_added' | 'member_removed' | 'member_role_changed' | 'project_updated' | 'visibility_changed' | 'project_archived' | 'project_deleted';
  actor: {
    id: string;
    name: string;
    avatar?: string;
...
export function ProjectActivityFeed({ projectId, activities = [], isLoading = false }: ProjectActivityFeedProps) {
