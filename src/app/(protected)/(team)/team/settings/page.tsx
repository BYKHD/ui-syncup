 ...
 * Resolves the user's active team from the database (no cookie write)
 * and redirects to the new slug-based URL /team/[slug]/settings.
 *
 * We query DB directly instead of getActiveTeam() because that function
 * calls syncTeamCookie() which is not allowed in Server Components.
 */
export default async function TeamSettingsRedirectPage() {
  ...
  // Resolve active team slug without touching cookies
