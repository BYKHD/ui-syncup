...
export function ProjectInvitationEmail({ 
  ...
  return (
    <EmailLayout preview={`Join ${projectName} on UI SyncUp`}>
      <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
        Join <strong>{projectName}</strong> on UI SyncUp
      </Heading>
      ...
      <Text className="text-black text-[14px] leading-[24px]">
        <strong>{inviterName}</strong> has invited you to join the <strong>{projectName}</strong> project on UI SyncUp as a <strong>{role}</strong>. Collaborate on issues, manage UI feedback, and streamline your development workflow.
      </Text>
